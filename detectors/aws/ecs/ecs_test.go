...
// 			content, err := os.ReadFile(filepath.Join("testdata", "metadatav4-response-task-ec2.json"))
// 			if err == nil {
...
// 			}
// 		} else {
// 			content, err := os.ReadFile(filepath.Join("testdata", "metadatav4-response-container-ec2.json"))
// 			if err == nil {
// 				_, err = res.Write(content)
// 				if err != nil {
// 					panic(err)
...
// 	testServer := httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
// 		if strings.HasSuffix(req.URL.String(), "/task") {
// 			content, err := os.ReadFile(filepath.Join("testdata", "metadatav4-response-task-fargate.json"))
// 			if err == nil {
// 				_, err = res.Write(content)
// 				if err != nil {
// 					panic(err)
...
// 			}
// 		} else {
// 			content, err := os.ReadFile(filepath.Join("testdata", "metadatav4-response-container-fargate.json"))
// 			if err == nil {
// 				_, err = res.Write(content)
// 				if err != nil {
// 					panic(err)
